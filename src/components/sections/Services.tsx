          ...
          {data.map((service, index) => {
            ...
            return (
              <motion.a
                ...
                className="group relative overflow-hidden block bg-[#0F172A] border border-white/5 rounded-xl p-8 hover:border-emerald-500/20 transition-all duration-300"
              >
                <div
                ...
                <ArrowRight
                  size={20}
                  className="absolute bottom-6 right-6 text-gray-700 group-hover:text-emerald-500 group-hover:translate-x-1 transition-all duration-300"
                />
              </motion.a>
            );
          })}
